                ...
                <div class="as-accessories" id="as-accessories">
                    ...
                    <div class="row">
                        <div class="column large-6" style="margin-left: 2rem;">
                            <p>
                                Ha ocurrido un error al realizar el pago o terminaste el proceso de compra de manera
                                inesperada, por favor verifica la información que proporcionaste e intentalo nuevamente.
                                No hemos realizado ningún cargo ni procesado esta compra.
                            </p>
                            <br>
                            <a class="button mercadopago-button" href="/">Ir al inicio</a>
                        </div>
                    </div>
                </div>
