 ...
 * external_reference y el ID de pago (payment_id o collection_id) de MercadoPago
 ...
 *
 *
 * https://www.tusitio.com/success.php?collection_id=10&collection_status=approved&external_reference=hello@sample.com&payment_type=credit_card&preference_id=100&site_id=site.com.mx&processing_mode=aggregator&merchant_account_id=null
 */
...
$collection_status = isset($_GET["collection_status"]) ? $_GET["collection_status"] : null;
...
$processing_mode = isset($_GET["processing_mode"]) ? $_GET["processing_mode"] : null;
$merchant_account = isset($_GET["merchant_account"]) ? $_GET["merchant_account"] : null;
        ...
        <div class="as-search-results as-filter-open as-category-landing as-desktop" id="as-search-results">
            ...
            <div id="accessories-tab" class="as-accessories-details">
                <div class="as-accessories" id="as-accessories">
                    ...
                    <div class="row">
                        <div class="column large-6" style="margin-left: 2rem;">
                            <p>
                                Gracias por comprar en nuestra tienda. Tu pago ha sido procesado exitosamente, recibirás
                                un correo electrónico con los detalles del pedido, y abajo puedes encontrar información
                                relevante acerca de tu pago.
                            </p>
                            <br>

                            <form class="form">
                                <div>
                                    <label style="font-weight: bold;" for="payment_type">Payment type: </label>
                                    <span><?php echo $payment_type; ?></span>
                                </div>

                                <div>
                                    <label style="font-weight: bold;" for="external_reference">External
                                        reference: </label>
                                    <span><?php echo $external_reference; ?></span>
                                </div>

                                <div>
                                    <label style="font-weight: bold;" for="collection_id">Collection ID: </label>
                                    <span><?php echo $collection_id; ?></span>
                                </div>

                                <div>
                                    <label style="font-weight: bold;" for="collection_status">Collection
                                        status: </label>
                                    <span><?php echo $collection_status; ?></span>
                                </div>

                                <div>
                                    <label style="font-weight: bold;" for="preference_id">Preference ID: </label>
                                    <span><?php echo $preference_id; ?></span>
                                </div>

                                <div>
                                    <label style="font-weight: bold;" for="site_id">Site ID: </label>
                                    <span><?php echo $site_id; ?></span>
                                </div>

                                <div>
                                    <label style="font-weight: bold;" for="processing_mode">Processing mode: </label>
                                    <span><?php echo $processing_mode; ?></span>
                                </div>

                                <div>
                                    <label style="font-weight: bold;" for="merchant_account">Merchant account: </label>
                                    <span><?php echo $merchant_account; ?></span>
                                </div>
                            </form>

                            <a class="button mercadopago-button" href="/" style="margin-top: 2rem;">Ir al inicio</a>
                        </div>
                    </div>
                </div>

                <div style="margin-bottom: 15rem; margin-top: 15rem;"></div>
