                ...
                <div class="as-accessories" id="as-accessories">
                    ...
                    <div class="row">
                        <div class="column large-6" style="margin-left: 2rem;">
                            <p>
                                Gracias por comprar en nuestro sitio, tu pago está siendo
                                procesado, una vez que lo hayas realizado recibirás una
                                notificación confirmando tu orden.
                            </p>
                            <br>
                            <a class="button mercadopago-button" href="/">Seguir comprando</a>
                        </div>
                    </div>
                </div>
