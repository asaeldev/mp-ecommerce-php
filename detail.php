 ...
 * Public-Key: APP_USR-d81f7be9-ee11-4ff0-bf4e-20c36981d7bf
 * Access-Token: APP_USR-1159009372558727-072921-8d0b9980c7494985a5abd19fbe921a3d-617633181
 *
 * TEST USER (PAGADOR)
 * ID: 655253974
 ...
 * Password: qatest7632
 *
 * Tarjetas adicionales para hacer las simulaciones de pago en testeo
 * Recuerda utilizar el prefijo APRO en el nombre del tarjetahabiente para simular un pago aprobado.
 * Visa: 4357 6064 1502 1810
 * MasterCard: 5031 7531 3431 1717
 *
 */
...
$item_price = isset($_POST["price"]) ? $_POST["price"] : null;
$item_title = isset($_POST["title"]) ? $_POST["title"] : null;
$item_img = isset($_POST["img"]) ? $_POST["img"] : null;
...
// Setting up items that will be sent to MP
$item = new MercadoPago\Item();
$item->id = 1234;
$item->title = $item_title;
$item->description = "Dispositivo móvil de Tienda e-commerce";
$item_img = substr($item_img, 2, strlen($item_img));
$item->picture_url = $_ENV["SITE_URL"] . $item_img;
$item->quantity = 1;
$item->currency_id = "MXN";
$item->unit_price = $item_price;
$item->external_reference = "asael.hernandez@codebase.com.mx";
...
$preference->back_urls = array(
    ...
    "failure" => $_ENV["FAILURE_PAYMENT_URL"],
    "pending" => $_ENV["PENDING_PAYMENT_URL"]
);
                    ...
                    <div class="as-accessories-results  as-search-desktop">
                        <div class="width:60%">
                                        ...
                                        <div class="clearfix image-list xs-no-js as-util-relatedlink relatedlink"
                                            ...
                                            <div class="as-tilegallery-element as-image-selected">
                                                ...
                                                <img src="./assets/003.jpg"
                                                     ...
                                                     height="445"
                                                     style="content:-webkit-image-set(url(<?php echo $item_img ?>) 2x);">
                                            </div>
                            ...
                            <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                    ...
                                    <div class="as-producttile-title">
                                        <h3 class="as-producttile-name">
                                            <p class="as-producttile-tilelink">
                                                <span data-ase-truncate="2"><?php echo $item_title ?></span>
                                            </p>

                                        </h3>
                                    </div>
                                    <h3>
                                        Precio: <?php echo "$" . $item_price ?>
                                    </h3>
                                    <h3>
                                ...
                                <a class="button mercadopago-button" href="<?php echo $preference->init_point; ?>">
                                    Pagar la compra
                                </a>
